class Admin::BusinessTypesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @business_type.save
        format.html { redirect_to admin_business_types_path, notice: 'Business type was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @business_type.update(business_type_params)
        format.html { redirect_to admin_business_types_path, notice: 'Business type was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to admin_business_types_path, notice: 'Business type was successfully destroyed.' }
  ...
  private
    ...
    def business_type_params
      params.require(:business_type).permit(:name, :business_icon)
    end
end
