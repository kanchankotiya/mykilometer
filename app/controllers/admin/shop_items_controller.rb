class Admin::ShopItemsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @shop_item.save
        format.html { redirect_to admin_shop_items_path, notice: 'Shop item was successfully created.' }
  ...
  def destroy
    @shop_item.destroy
    respond_to do |format|
      format.html { redirect_to admin_shop_items_path, notice: 'Shop item was successfully destroyed.' }
  ...
  private
    ...
    def shop_item_params
      params.require(:shop_item).permit(:item_name, :shop_id, :item_price)
    end
end
