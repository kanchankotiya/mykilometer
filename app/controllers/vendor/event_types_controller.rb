class Vendor::EventTypesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @event_type.save
        format.html { redirect_to vendor_event_types_path, notice: 'Event type was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @event_type.update(event_type_params)
        format.html { redirect_to  vendor_event_types_path, notice: 'Event type was successfully updated.' }
  ...
  def destroy
    @event_type.destroy
    respond_to do |format|
      format.html { redirect_to  vendor_event_types_path, notice: 'Event type was successfully destroyed.' }
